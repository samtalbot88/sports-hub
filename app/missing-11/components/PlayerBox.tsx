...
type PlayerBoxProps = {
  ...
  const PlayerBox = forwardRef<PlayerBoxHandle, PlayerBoxProps>(function PlayerBox(
    {
      shirtNumber,
      maskedName,
      answer,
...
useEffect(() => {
  ...
  // hydrate once from LocalStorage-loaded state
...
flex flex-col items-center justify-start pt-2 text-xs text-white
    ...
    >
      ...
      {/* Desktop: stacked icon buttons (Hint + Reveal) */}
      <div
      ...
      {/* Desktop-only masked/correct/revealed name */}
      <div
      ...
      {/* Points row (mobile can show this too) */}
      <div
    ...
    {/* Mobile-only result row OUTSIDE the shirt box */}
{/* Mobile-only: show solved name above points */}
